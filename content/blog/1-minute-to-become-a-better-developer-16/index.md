---
title: 1 Minute To Become A Better Developer (#16)
...
```com/jportella93/9aa6972a7781de41533096923fef8dc8/raw/
const myArr = [1, 2]
...
```com/jportella93/df9a987fc64dca13953f56c164afa921/raw/
const myArr = [1, 2];
