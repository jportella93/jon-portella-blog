...
// this works on a standalone html file (although I didn't receive the money, maybe because it was not over https), make it work in react

{/* 
  
<div id="smart-button-container">
<div style="text-align: center"><label for="description">Concept </label><input type="text" name="descriptionInput"
