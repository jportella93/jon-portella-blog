...
export const PRE_GAME_STATE_INIT_QUESTION = 'PRE_GAME_STATE_INIT_QUESTION';
...
export const GAME_STATE_PRE_SELECT_DIFFICULTY = 'GAME_STATE_PRE_SELECT_DIFFICULTY';
export const GAME_STATE_SELECT_DIFFICULTY = 'GAME_STATE_SELECT_DIFFICULTY';
export const GAME_STATE_POST_SELECT_DIFFICULTY = 'GAME_STATE_POST_SELECT_DIFFICULTY';
...
export const GAME_PRESENTATION = 'GAME_PRESENTATION';
export const GAME_CATCH_NAME = 'GAME_CATCH_NAME';
